            ...
            }
            {
                ...
                <div className="sidebar-dropdown-menu-div">  <button  className={`sidebar-dropdown-menu-a evis-font`}>Ervi AS</button></div>
                 ...
                 <div><button  className={`sidebar-dropdown-menu-a  ${location.pathname==="/lonnskrav"?"active": ""}`}>Alle lonnskrav (3)</button>
                   ...
                   <div className="sidebar-dropdown-menu-div">  <a href="/" className={`sidebar-dropdown-menu-a`}>Kreditorer og Fordringer</a></div>
                   <div className="sidebar-dropdown-menu-div">  <a href="/" className={`sidebar-dropdown-menu-a`}>Regnskap</a></div>
                   <div className="sidebar-dropdown-menu-div"><a href="/" className={`sidebar-dropdown-menu-a`}>Meldinger</a></div>
                   <div className="sidebar-dropdown-menu-div brd-none"> <a href="/" className={`sidebar-dropdown-menu-a`}>Oppgaver</a></div>
